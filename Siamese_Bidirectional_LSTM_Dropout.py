...
from tensorflow.keras.layers import Input, Concatenate, Conv2D, Flatten, Dense, Embedding, LSTM, Bidirectional
...
lstm = Bidirectional(LSTM(50, return_sequences = True, activation = 'relu', dropout = 0.2))
